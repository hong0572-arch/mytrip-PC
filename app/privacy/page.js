...
export default function Privacy() {
  const provisions = [
    ...
    },
    {
      ...
      desc: "이용자는 언제든지 본인의 개인정보 열람, 오류 수정 및 동의 철회(회원 탈퇴)를 요구할 수 있습니다. 개인정보 관리 및 정보 보호에 관해 의문점이 있거나 건의 사항이 있으신 경우, 공식 개인정보 처리 책임자 대리 이메일인 tripmaker@tripmaker.tips 로 연락해 주시면 성실히 처리해 드리겠습니다."
    }
  ];
