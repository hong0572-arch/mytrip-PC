...
const GUIDE_DATA_KO = [
  {
    ...
    items: [
      {
        subtitle: "0-1. 실시간 보호 시작",
        details: [
          { label: "보호자 검색 및 등록", desc: "이메일이나 이름으로 서비스 가입자를 검색하여 비상 보호자로 등록하거나, 연락처 정보를 직접 입력할 수 있습니다." },
          { label: "안심 약속 귀가 시간 설정", desc: "이동 예상 시간에 맞춰 10분, 30분, 60분, 120분 등의 타이머를 설정합니다." }
        ]
      },
      {
        subtitle: "0-2. Safe Mode",
        details: [
          { label: "사이렌 올리기", desc: "직접 사이렌을 올리면 고주파 사이렌과 경고가 작동하고 비상 연락망에 자동 통지됩니다." },
          { label: "실시간 위치 전송", desc: "약속 시간 내에 귀가 완료를 인증하지 않으면 고주파 사이렌과 경고가 작동하고 비상 연락망에 자동 통지됩니다." },
