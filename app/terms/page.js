...
export default function Terms() {
  const sections = [
    {
      title: "제 1 조 (목적)",
      content: "본 약관은 트립메이커(이하 '회사' 또는 '서비스')가 제공하는 웹 사이트(tripmaker.tips) 및 안드로이드 모바일 어플리케이션(이하 '서비스')을 통해 제공하는 여행 AI 최적화 동선 계획, 동행 매칭, 1/N 정산 요청 모임통장, 및 기타 부가 서비스의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다."
    },
    {
      title: "제 2 조 (용어의 정의)",
