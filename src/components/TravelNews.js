    ...
    if (error || newsItems.length === 0) {
        return (
            <div className="w-full text-center py-4">
                ...
                <button onClick={fetchNews} className="mt-2 text-xs text-blue-600 font-bold flex items-center gap-1 mx-auto">
        ...
        <div className="w-full">
            ...
            <div className="flex items-center justify-between mb-3 px-1">
                <div className="flex items-center gap-2">
                    <div className="w-6 h-6 bg-gradient-to-br from-blue-600 to-sky-400 rounded-lg flex items-center justify-center">
